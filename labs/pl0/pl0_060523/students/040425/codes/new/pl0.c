...
{
	mask* mk;
    int position();    /*Added by XSun&HYC,and this modification is nonimportant........25/04/2004*/
...
void block(symset fsys)
{
	...
	mask* mk;
	int block_dx;
	//int savedTx;   /*Deleted by XSun&HYC.........25/04/2004*/
	symset set1, set;
	...
	do
	{
		...
		{ // procedure declarations
			...
			level++;
			//savedTx = tx;  /* deleted by XSun&HYC......25/04/2004*/
			set1 = createset(SYM_SEMICOLON, SYM_NULL);
			set = uniteset(set1, fsys);
			block(set);
			destroyset(set1);
			destroyset(set);
			//tx = savedTx;  /* deleted by XSun&HYC......25/04/2004*/
			level--;
